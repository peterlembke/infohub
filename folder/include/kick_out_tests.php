 ...
 */
    ...
    if (isset($_COOKIE['PHPSESSID']) === false) {
        GetOut(0.0, 'One <a href="http://en.wikipedia.org/wiki/HTTP_cookie" target="_blank">session cookie</a> must be stored in your browser.<br />And <a href="http://en.wikipedia.org/wiki/Web_storage" target="_blank">local storage</a> (if exist) will be used to store data that you can use when you are offline.<br /><br /><a href="javascript:window.location.reload()">Reload the page</a> if you accept this.<br /><br />If you got here again after pressing reload, then your web browser do not accept cookies. You can <a href="http://www.google.com/support/accounts/bin/answer.py?&answer=61416" target="_blank">activate cookies</a>.<br /><br /><INPUT type="button" class="button" NAME="ok" id="ok" Value="Accept" onClick="window.location.reload()">');
    }
