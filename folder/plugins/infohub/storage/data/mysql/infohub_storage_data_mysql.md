...
<a href="https://www.mysql.com/" target="_blank">MySQL</a> is one of the supported database engines that Storage can
use.  
...
You need to manually create a database on a MySQL database server and prepare for connection credentials. The user you
set up in the MySQL server must be allowed to handle the database, be allowed to create tables.
...
engine because it was too complicated. I kept this illogical name as a memory.
