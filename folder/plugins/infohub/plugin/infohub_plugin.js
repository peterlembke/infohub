/**
 * infohub_plugin
 * Used by infohub_exchange to handle plugin requests. Finds the plugin in local storage or requests it from the server, then starts the plugin
 *
 * @package     Infohub
 ...
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/plugin/infohub_plugin.md Documentation
