/**
 * infohub_keyboard
 * When you use the keyboard then an event message come here. You can subscribe to key strokes
 *
 * @package     Infohub
 * @subpackage  infohub_keyboard
 * @since       
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/keyboard/infohub_keyboard.md Documentation
