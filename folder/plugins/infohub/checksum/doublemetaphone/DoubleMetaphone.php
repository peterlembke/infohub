 ...
 * @version     2002-05-17
 * @since       2002-05-17
 * @copyright   Copyright (c) 2002, Stephen Woodbridge <woodbri@swoodbridge.com>
 * @license     This module is free software; you may redistribute it and/or modify it under the same terms as Perl itself.
    ...
    public function __construct($string)
    {
        ...
        while (strlen($this->primary) < 4 || strlen($this->secondary) < 4) {
            ...
            switch (substr($this->original, $this->current, 1)) {
                ...
                case 'C' :
                    // various gremanic
                    if (($this->current > 1) && !$this->IsVowel($this->original, $this->current - 2) && $this->StringAt(
                            $this->original,
                            $this->current - 1,
                            3,
                            [
                ...
                case 'G' :
                    if (substr($this->original, $this->current + 1, 1) == 'H') {
                        ...
                        if ((($this->current > 1) && $this->StringAt(
                                    $this->original,
                                    $this->current - 2,
                                    1,
                                    [
                    ...
                    if (substr($this->original, $this->current + 1, 1) == 'N') {
                        if (($this->current == 1) && $this->IsVowel($this->original, 0) && !$this->SlavoGermanic(
                                $this->original
                            )) {
                            $this->primary .= "KN";
                            $this->secondary .= "N";
                ...
                case 'H' :
                    ...
                    if ((($this->current == 0) || $this->IsVowel(
                                $this->original,
                                $this->current - 1
                ...
                case 'J' :
                    ...
                    if (($this->current == 0) && !$this->StringAt(
                        ...
                        if ($this->IsVowel($this->original, $this->current - 1) && !$this->SlavoGermanic(
                                $this->original
                            ) && ((substr($this->original, $this->current + 1, 1) == 'A') || (substr(
                                        $this->original,
                                        $this->current + 1,
                                        1
                                    ) == 'O'))) {
                ...
                case 'L' :
                    if (substr($this->original, $this->current + 1, 1) == 'L') {
                        ...
                        if ((($this->current == ($this->length - 3)) && $this->StringAt(
                                    $this->original,
                                    $this->current - 1,
                                    4,
                                    [
                ...
                case 'R' :
                    ...
                    if (($this->current == $this->last) && !$this->SlavoGermanic($this->original) && $this->StringAt(
                            $this->original,
                            $this->current - 2,
                            2,
                            [
                ...
                case 'S' :
                    ...
                    if ($this->StringAt(
                        ...
                        if (substr($this->original, $this->current + 2, 1) == 'H') {
                            ...
                            if ($this->StringAt(
                                ...
                                if (($this->current == 0) && !$this->IsVowel($this->original, 3) && (substr(
                                            $this->original,
                                            $this->current + 3,
                                            1
                                        ) != 'W')) {
                    ...
                    if (($this->current == $this->last) && $this->StringAt(
                            $this->original,
                            $this->current - 2,
                            2,
                            [
                ...
                case 'W' :
                    ...
                    if ((($this->current == $this->last) && $this->IsVowel(
                                $this->original,
                                $this->current - 1
                            )) || $this->StringAt(
                            $this->original,
