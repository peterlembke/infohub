/**
 * Workbench
 * Handles what you see on screen with an app menu and a separate box for each started app, there the app can show its things.
 *
 * @package     Infohub
 * @subpackage  infohub_workbench
 * @since       2017-03-08
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/workbench/infohub_workbench.md Documentation
                ...
                'data': {
                    'what': {
                        ...
                        'menutitle': {
                            ...
                            'tag': 'div',
                            'css_data': {
                                '.menutitle': 'max-width:78px; padding:1px; font-size:' +
                                    $fontSize +
                                    'em; text-align:center; height:32px; border-radius: 0px 0px 8px 8px; box-sizing: border-box;',
