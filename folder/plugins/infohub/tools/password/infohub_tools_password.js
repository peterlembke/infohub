 ...
 * Render a form for generating passwords in different formats
 *
 * @package     Infohub
 * @subpackage  infohub_tools_password
 * @since       2018-08-04
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/tools/password/infohub_tools_password.md Documentation
