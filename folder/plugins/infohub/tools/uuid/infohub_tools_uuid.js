/**
 * infohub_tools_uuid
 * Render a form for testing UUID
 *
 * @package     Infohub
 * @subpackage  infohub_tools_uuid
 * @since       2018-07-26
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/tools/uuid/infohub_tools_uuid.md Documentation
