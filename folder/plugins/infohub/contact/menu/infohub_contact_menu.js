 ...
 *
 * @package     Infohub
 * @subpackage  infohub_contact_menu
 * @since       2019-02-16
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/contact/menu/infohub_contact_menu.md Documentation
                ...
                'data': {
                    'what': {
                        'titel': {
                            'type': 'common',
                            'subtype': 'value',
                            'data': _Translate('CONTACT_MANAGER')
                        },
                        'my_menu': {
                            ...
                            'options': {
                                ...
                                'client': {
                                    ...
                                    'button_label': _Translate('CLIENT_CONTACT'),
                                ...
                                'server': {
                                    ...
                                    'button_label': _Translate('SERVER_CONTACT'),
