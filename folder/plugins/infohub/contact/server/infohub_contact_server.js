 ...
 *
 * @package     Infohub
 * @subpackage  infohub_contact_server
 * @since       2019-02-16
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/contact/server/infohub_contact_server.md Documentation
                ...
                'data': {
                    'what': {
                        ...
                        'list_contacts': {
                            'plugin': 'infohub_renderform',
                            'type': 'select',
                            "label": _Translate("SERVER_CONTACTS"),
                            "description": _Translate("LIST_ALL_SERVER_CONTACTS"),
                            "size": "20",
                            "multiple": "false",
                        ...
                        'button_ping': {
                            ...
                            'type': 'button',
                            'mode': 'button',
                            'button_label': _Translate('PING_SERVER'),
                        ...
                        'text_node': {
                            ...
                            'description': _Translate('YOUR_UNIQUE_NODE_NAME'),
                            'maxlength': '30',
                            'validator_plugin': 'infohub_validate',
                            'validator_function': 'validate_has_data',
                        ...
                        'text_domain_address': {
                            ...
                            'description': _Translate('THE_DOMAIN_ADDRESS_TO_THE_REMOTE_SERVER'),
                            'maxlength': '50',
                            'validator_plugin': 'infohub_validate',
                            'validator_function': 'validate_has_data',
                            'show_characters_left': 'false',
                        ...
                        'text_user_name': {
                            ...
                            'description': _Translate('HUB-UUID_YOU_GOT_FROM_THE_REMOTE_SERVER'),
                            'maxlength': '50',
                            'show_characters_left': 'false',
                            'enabled': 'false',
                        },
                        'text_shared_secret': {
                            ...
                            'description': _Translate('2K_RANDOM_STRING_YOU_GOT_FROM_THE_REMOTE_SERVER'),
                            'show_characters': 'false',
                            'show_words': 'false',
                            'show_rows': 'false',
                            'show_paragraphs': 'false',
                        ...
                        'list_role_list': {
                            ...
                            "description": _Translate("LIST_WITH_ALL_ROLES_THIS_ACCOUNT_HAS"),
                            'event_data': 'server',
                            "size": "6",
                            "options": [
            ...
            return _SubCall({
                ...
                'data': {
                    ...
                    'form_data': {
                        ...
                        'list_role_list': {
                            'value': $in.response.node_data.role_list,
                            'mode': 'clean_and_add',
                        },
                    },
                },
