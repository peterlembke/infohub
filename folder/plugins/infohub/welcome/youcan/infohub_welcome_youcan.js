 ...
 *
 * @package     Infohub
 * @subpackage  infohub_welcome_youcan
 * @since       2015-02-12
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/welcome/youcan/infohub_welcome_youcan.md Documentation
