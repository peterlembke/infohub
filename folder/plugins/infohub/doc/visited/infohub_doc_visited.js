/**
 * Visited
 * Render list with the latest visited documents
 *
 * @package     Infohub
 * @subpackage  infohub_doc_visited
 * @since       2019-04-13
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/doc/visited/infohub_doc_visited.md Documentation
