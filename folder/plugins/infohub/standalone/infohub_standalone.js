/**
 * Stand alone
 * Start ONE workbench plugin so you can run it without Workbench. Use with a unique domain URL and set it up in folder/config/infohub_exchange.json
 *
 * @package     Infohub
 * @subpackage  infohub_standalone
 * @since       
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/standalone/infohub_standalone.md Documentation
