/**
 * infohub_translate_manual
 * Here you can manually send text to LibreTranslate and get an answer
 *
 * @package     Infohub
 * @subpackage  infohub_translate_manual
 * @since       2021-09-09
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/translate/manual/infohub_translate_manual.md Documentation
