                ...
                'data': {
                    'what': {
                        'my_presentation_box': {
                            ...
                            'head_label': _Translate('CREATE_FILES'),
                        ...
                        'select_plugin': {
                            ...
                            "description": _Translate("LISTS_ALL_CLIENT_PLUGINS_THAT_CAN_HAVE_TRANSLATION_FILES._SELECT_A_PLUGIN_AND_CLICK_CREATE_FILES."),
                            "size": "6",
                            "multiple": "false",
                            "options": [],
                            'source_node': 'client',
                        ...
                        'button_create_files': {
                            ...
                            'type': 'button',
                            'mode': 'button',
                            'button_label': _Translate('CREATE_FILES'),
