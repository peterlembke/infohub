 ...
 */
function infohub_libretranslate_doc() {
...
// include "infohub_base.js"
    ...
    const _Version = function() {
        return {
            ...
            'version': '1.0.0',
            'checksum': '{{checksum}}',
            'class_name': 'infohub_libretranslate_doc',
                ...
                'data': {
                    'what': {
                        'container_buttons': {
                            ...
                            'subtype': 'container',
                            'tag': 'div',
                            'data': '[button_main][button_manual]',
    ...
    const click_main = function($in = {}) {
        ...
        if ($in.step === 'step_render') {
            return _GetCall('infohub_libretranslate');
        }
    ...
    const click_manual = function($in = {}) {
        ...
        if ($in.step === 'step_render') {
            return _GetCall('infohub_libretranslate_manual');
        }
    ...
    const _GetCall = function($fileName) {
        ...
        const $pluginName = 'infohub_libretranslate';
...
//# sourceURL=infohub_libretranslate_doc.js