 ...
 */
function infohub_libretranslate_manual() {
...
// include "infohub_base.js"
    ...
    const _Version = function () {
        return {
            ...
            'version': '1.0.0',
            'checksum': '{{checksum}}',
            'class_name': 'infohub_libretranslate_manual',
                ...
                'data': {
                    'what': {
                        ...
                        'from_language': {
                            ...
                            "options": [],
                            'source_node': 'client',
                            'source_plugin': 'infohub_libretranslate',
                            'source_function': 'get_language_option_list',
                            'source_data': {
                    ...
                    'where': {
                        'box_id': 'main.body.infohub_libretranslate.form', // 'box_id': $in.parent_box_id + '.form',
                        'max_width': 960,
    ...
    const click_refresh = function ($in = {}) {
        ...
        let $messages = [],
            $fromLanguage = $in.config.from_language,
        ...
        return {
            'answer': 'true',
            'message': 'Have sent the refresh of the language lists',
            'ok': 'true',
            'messages': $messages
        };
    };
    ...
    const click_translate = function ($in = {}) {
        ...
        if ($in.step === 'step_form_read_response') {
            ...
            if ($in.response.answer === 'true') {
                ...
                if ($toLanguage === '') {
                    $in.data_back.message = _Translate('PICK_A_LANGUAGE');
                    $in.step = 'step_end';
                }
            }
        }
...
//# sourceURL=infohub_libretranslate_manual.js