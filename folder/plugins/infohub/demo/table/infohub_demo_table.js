 ...
 *
 * @package     Infohub
 * @subpackage  infohub_demo_table
 * @since       2019-12-31
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/demo/table/infohub_demo_table.md Documentation
...
// include "infohub_base.js"
                ...
                'data': {
                    'what': {
                        'my_table': {
                            ...
                            'data': [
                                {
                                    'hub_id': '1578031402.443:588342714995535',
                                    'name': 'Ab',
                                    'year': '2000',
                                    'score': 10,
                                    'email': 'ab@email.com',
                                ...
                                {
                                    'hub_id': '1578031501.037:8282858282167634',
                                    'name': 'Ba',
                                    'year': '1999',
                                    'score': -5,
                                    'email': 'ba@email.com',
                                ...
                                {
                                    'hub_id': '1578031519.928:5102017188330457',
                                    'name': 'Ce',
                                    'year': '1997',
                                    'score': 3,
                                    'email': 'ce@email.com',
                                ...
                                {
                                    'hub_id': '1578031537.655:80290150987442',
                                    'name': 'Du',
                                    'year': '2005',
                                    'score': 7,
                                    'email': 'du@email.com',
                                ...
                                {
                                    'hub_id': '1578031557.069:9570541949382424',
                                    'name': 'Fe',
                                    'year': '1997',
                                    'score': -8,
                                    'email': 'fe@email.com',
                                ...
                                {
                                    'hub_id': '1578031571.334:12142242923887636',
                                    'name': 'Go',
                                    'year': '1997',
                                    'score': 3,
                                    'email': 'go@email.com',
    ...
    const click_row = function($in = {}) {
        ...
        if ($in.step === 'step_start') {
            const $text = _Translate('CLICKED_ROW_WITH_ID:') + ' ' + $in.event_data;
