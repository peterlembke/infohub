 ...
 *
 * @package     Infohub
 * @subpackage  infohub_demo_common
 * @since       2017-02-11
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/demo/common/infohub_demo_common.md Documentation
