/**
 * infohub_language
 * Helps you with language codes
 *
 * @package     Infohub
 * @subpackage  infohub_language
 * @since       2019-04-02
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/language/infohub_language.md Documentation
