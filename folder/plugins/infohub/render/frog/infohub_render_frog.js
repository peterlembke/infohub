/**
 * infohub_render_frog
 * Render HTML for a frog. If you give bad instructions to the renderer then you get a frog.
 *
 * @package     Infohub
 * @subpackage  infohub_render_frog
 * @since       2016-10-08
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/render/frog/infohub_render_frog.md Documentation
...
function infohub_render_frog() {
    ...
    const internal_Frog = function($in = {}) {
        ...
        let $html = '<img ' + $id + ' src="' + $imageData + '" alt="'+ $in.alt_text +'">';
