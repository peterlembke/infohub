/**
 * infohub_render_map
 * Render HTML for a map from OpenStreetMap, Google Maps, GPSies
 *
 * @package     Infohub
 * @subpackage  infohub_render_map
 * @since       2014-11-01
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/render/map/infohub_render_map.md Documentation
