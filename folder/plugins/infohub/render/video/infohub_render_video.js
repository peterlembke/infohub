 ...
 * Render HTML for a video from YouTube, Vimeo
 *
 * @package     Infohub
 * @subpackage  infohub_render_video
 * @since       2014-11-01
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/render/video/infohub_render_video.md Documentation
