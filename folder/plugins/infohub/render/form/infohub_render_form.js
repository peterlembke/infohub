/**
 * infohub_render_form
 * Render HTML for form elements like buttons, text, checkbox, radio button, select
 *
 * @package     Infohub
 * @subpackage  infohub_render_form
 * @since       2018-05-27
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/render/form/infohub_render_form.md Documentation
