 ...
 * Render HTML for features like images, iframes, containers, legends, lists, progress etc
 *
 * @package     Infohub
 * @subpackage  infohub_render_common
 * @since       2015-02-15
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/render/common/infohub_render_common.md Documentation
