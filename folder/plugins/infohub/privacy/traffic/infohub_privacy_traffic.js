/**
 * infohub_privacy_traffic
 * Tools for checking traffic privacy
 *
 * @package     Infohub
 * @subpackage  infohub_privacy_traffic
 * @since       2020-05-01
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/privacy/traffic/infohub_privacy_traffic.md Documentation
 * @link        https://infohub.se/ InfoHub main page
 */
function infohub_privacy_traffic() {
...
// include "infohub_base.js"
    ...
    const _Version = function() {
        return {
            ...
            'version': '1.0.0',
            'checksum': '{{checksum}}',
            'class_name': 'infohub_privacy_traffic',
            'note': 'Tools for checking traffic privacy',
            'status': 'normal',
    ...
    const create = function($in = {}) {
        const $default = {
            ...
            'response': {
                'answer': 'false',
                'message': 'Nothing to report from privacy_traffic',
            },
        };
