/**
 * infohub_privacy_server
 * Tools for checking server privacy
 *
 * @package     Infohub
 * @subpackage  infohub_privacy_server
 * @since       2020-05-01
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/privacy/server/infohub_privacy_server.md Documentation
