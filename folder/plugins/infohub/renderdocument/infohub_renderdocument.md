...
You realize now that you can render anything in your Markdown texts as long as you provide how to render it in the subcall.
If a tag is `[missing]` data then it will be removed.
```
return _SubCall({
    'to': {
        'node': 'client',
