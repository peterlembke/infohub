/**
 * Document
 * Take a markdown, parse some of it and divide into renderable parts
 * * @package     Infohub
 * @subpackage  infohub_renderdocument
 * @since       2019-08-09
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/renderdocument/infohub_renderdocument.md Documentation
