                    ...
                    'do': [
                        ...
                        },
                        {
                            ...
                            'boxes_data': {
                                ...
                                'refresh': '' // Contains a refresh button so you can restart the webapp
                            }
                        },
                        {
                            'func': 'BoxMode',
    ...
    var render_list = function ($in)
    {
        ...
        if ($in.step === 'step_read_local_list') {
            return _SubCall({
                ...
                'data': {
                    'path': 'infohub_launcher/' + $listName
                },
                'data_back': {
                    'list_name': $listName,
    ...
    var get_list = function ($in)
    {
        ...
        if ($in.step === 'step_start') {
            return _SubCall({
                ...
                'data': {
                    'path': 'infohub_launcher/' + $in.list_name
                },
                'data_back': {
                    'list_name': $in.list_name,
                    'step': 'step_end'
    ...
    var update_full_list = function ($in)
    {
        ...
        if ($in.step === 'step_get_full_list_from_client')
        {
            return _SubCall({
                ...
                'data': {
                    'path': 'infohub_launcher/full_list'
                },
                'data_back': {
