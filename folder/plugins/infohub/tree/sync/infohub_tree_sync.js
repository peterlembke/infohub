/**
 * infohub_tree_sync
 * Sync the local data with the server data
 *
 * @package     Infohub
 * @subpackage  infohub_tree_sync
 * @since       2020-07-25
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/tree/sync/infohub_tree_sync.md Documentation
