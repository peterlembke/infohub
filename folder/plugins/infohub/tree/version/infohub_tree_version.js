/**
 * infohub_tree_version
 * Show version information for all child plugins and parent plugin
 *
 * @package     Infohub
 * @subpackage  infohub_tree_version
 * @since       2020-07-25
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/tree/version/infohub_tree_version.md Documentation
