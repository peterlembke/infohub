/**
 * infohub_tree_menu
 * Render a menu for infohub_tree
 *
 * @package     Infohub
 * @subpackage  infohub_tree_menu
 * @since       2020-07-25
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/tree/menu/infohub_tree_menu.md Documentation
