 ...
 *
 * @package     Infohub
 * @subpackage  infohub_configlocal_zoom
 * @since       2018-05-25
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/configlocal/zoom/infohub_configlocal_zoom.md Documentation
