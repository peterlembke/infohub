 ...
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/configlocal/infohub_configlocal.md Documentation
                    ...
                    'items': [
                        {
                            ...
                            'box_alias': 'menu',
                            'max_width': 320,
                            'box_data': _Translate('THE_MENU_WILL_RENDER_HERE')
                        },
                        {
                            'parent_box_id': $in.box_id,
                            'box_position': 'last',
                            ...
                            'box_data': _Translate('USE_THE_MENU')
                        },
                        {
                            'parent_box_id': $in.box_id,
                            'box_position': 'last',
