/**
 * infohub_rendermajor
 * Renders a display box for content by assembling smaller standard parts
 *
 * @package     Infohub
 * @subpackage  infohub_rendermajor
 * @since       2016-10-26
 * @author      Peter Lembke <info@infohub.se>
 * @license     GPL-3.0-or-later
 * @copyright   Copyright (C) 2010- Peter Lembke
 * @see         https://github.com/peterlembke/infohub/blob/main/folder/plugins/infohub/rendermajor/infohub_rendermajor.md Documentation
